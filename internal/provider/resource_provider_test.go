...
func testUnitVsphereProviderConfig(host string) string {
...
// TestUnitVsphereProviderResource exercises ssp_vsphere_provider's Create and
...
func TestUnitVsphereProviderResource(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testUnitVsphereProviderConfig(srv.URL),
